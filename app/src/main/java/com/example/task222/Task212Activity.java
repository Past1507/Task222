...
public class Task212Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_task212);
        initViews();
    }
    ...
    public void clickOnBtn (View btn) {
        Toast.makeText(Task212Activity.this
